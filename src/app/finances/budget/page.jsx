...
export default function Budget() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await fetch('/website/data/finances/budget/budgets.json');
        ...
        <section>
            ...
            <div className="main lg:text-lg">
                <p className="p-3">
                    ...
                    visit our <Link href="/website/finances/conferences-competitions">Conferences & Competitions Page</Link>. Budget details are described in this page.
                </p>
                <div className="intro md:w-4/5 lg:w-3/4 mx-auto bg-highlight-blue rounded-sm shadow-md flex flex-col py-8 justify-center items-center">
                    ...
                    <p className="my-3 mx-6 lg:w-1/2 text-center">
                        ...
                        check out our <a href="/website/assets/budgets/SGCU-funding-guidelines.pdf" target="_blank">Student Groups and Course Unions Funding Guidelines</a>.
                    </p>
                    <hr className="border border-gray-400 lg:w-3/4 w-4/5 mt-4 mb-5 mx-auto" />
                    <h3 className="my-2 text-2xl lg:text-3xl xl:text-4xl font-serif font-semibold tracking-wide">
                        Policies and Rules
                    ...
                    <p className="my-3 mx-6 lg:w-1/2 text-center">
                        ...
                        our <Link href="/website/finances/policies">Financial Policies Page</Link>.
                    </p>
                </div>
                ...
                <div className="budgets my-4 lg:my-6 py-2">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4 lg:gap-6 pt-4">
                        {budgets.map((budget) => (
                            <div key={budget.id} className="text-center">
                                <a href={`/website/assets/budgets/${budget.path}`} target="_blank">
                    ...
                    <p className="pt-4 my-3 italic">
                        ...
                        our <Link href='/website/contact'>Contact Us Page</Link> to request it.
                        Our YTD for the 2023-2024 fiscal year (as of February 24, 2024) can be 
                        found <a href="/website/assets/budgets/YTD-02-24.pdf" target="_blank">here</a>.
                    </p>
                </div>
                ...
                <div className="resources my-2 lg:my-6 py-2">
                    ...
                    <div className="flex flex-wrap gap-4 mx-auto justify-center">
                        <div className="bg-highlight-blue rounded-sm shadow-md w-full h-full p-4">
                            ...
                            <p className="m-4">
                                For the account codes, check out our list of <a href="/website/assets/budgets/USSTM-AccountCodes.pdf" target="_blank">Account Codes</a> that we use 
                        ...
                        <div className="bg-highlight-blue rounded-sm shadow-md w-full h-full p-4">
                            ...
                            <p className="m-4">
                                ...
                                where our money goes and help you create your own as well. Please click <a href="/website/assets/budgets/howToReadUSSTMBudget.pdf" target="_blank">here</a> to
                                access the document.
                            </p>
                        </div>
                    </div>
