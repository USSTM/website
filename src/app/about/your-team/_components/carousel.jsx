...
export default function Carousel({ img1, img2, img3, name }) {
    return (
        ...
        >
            <SwiperSlide>
                <Image
                    overrideSrc={`/website/images/about/your-team/carousel-images/${img1}`}
                    alt={name}
                    width={2250}
                    height={1500}
                    loading='lazy'
            ...
            <SwiperSlide>
                <Image
                    overrideSrc={`/website/images/about/your-team/carousel-images/${img2}`}
                    alt={name}
                    width={2250}
                    height={1500}
                    loading='lazy'
            ...
            <SwiperSlide>
                <Image
                    overrideSrc={`/website/images/about/your-team/carousel-images/${img3}`}
                    alt={name}
                    width={2250}
                    height={1500}
                    loading='lazy'
