    ...
    return (
        <section>
            ...
            <div className="main space-y-5 lg:text-lg">
                <div
                    className="flex items-center justify-center bg-[url(/website/images/about/meetings/usstm-meetings-header-bg.png)] bg-center bg-cover h-52">
                ...
                <div className={'bg-highlight-blue text-foreground shadow-sm lg:shadow-md rounded grid grid-rows-[auto_auto] grid-cols-1 md:grid-rows-1 md:grid-cols-2'}>
                    ...
                    <div className="image">
                        <Image
                            ...
                            overrideSrc={'/website/images/about/meetings/meetings-graphic.jpg'}
