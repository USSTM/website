...
export default function CRO() {
    const [isFunny, setIsFunny] = useState(Math.floor(Math.random()*10) <= 8);

    useEffect(() => {
        setIsFunny(Math.floor(Math.random()*10) <= 8);
    }, []);
    ...
    return (
        <div className="flex flex-col pt-10 pb-5">
            ...
            <div className="flex flex-col lg:flex-row bg-highlight-blue w-full rounded-md p-8 justify-center items-center">
                {isFunny ?
                <Image
                    overrideSrc={`/website/images/elections2024/cro.jpg`}
                    loading="lazy"
                ...
                /> :
                    <Image overrideSrc={`/website/images/elections2024/cro-ken.jpg`}
                           loading="lazy"
                           alt="The USSTM Chief Returning Officer for 2024 Elections"
                           width={1000}
                           height={1000}
