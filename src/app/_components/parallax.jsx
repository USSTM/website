                    ...
                    <div id="stats-box">
                        <div id="stats-text">
                            <div id="stats-students">
                                <Image
                                    overrideSrc="/website/images/homepage/stats-icons/students-icon.png"
                            ...
                            <div id="stats-groups">
                                <Image
                                    overrideSrc='/website/images/homepage/stats-icons/groups-icon.png'
                            ...
                            <div id="stats-board">
                                <Image
                                    overrideSrc='/website/images/homepage/stats-icons/board-icon.png'
